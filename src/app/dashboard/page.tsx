...
import { Calendar, Search, Video, AlertCircle, FileText, BookOpen, Settings, GraduationCap } from 'lucide-react'
            ...
            <div className="bg-white dark:bg-navy-800 rounded-xl border border-gray-200 dark:border-navy-700 p-6">
              ...
              <div className="space-y-3">
                ...
                <Link href="/apply-instructor">
                  <Button variant="outline" className="w-full justify-start gap-2 border-sage-200 dark:border-sage-800 text-sage-700 dark:text-sage-400 hover:bg-sage-50 dark:hover:bg-sage-900/20">
                    <GraduationCap className="h-4 w-4" />
                    {locale === 'ja' ? '講師として教えませんか？' : 'Apply as Instructor'}
                  </Button>
                </Link>
