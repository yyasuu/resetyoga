        ...
        <div className="bg-white dark:bg-navy-900 rounded-xl shadow-sm border border-gray-100 dark:border-navy-800 overflow-hidden">
          <table className="w-full text-sm">
            <tbody className="divide-y divide-gray-100 dark:divide-navy-800">
              ...
              <Row label="役務の内容">
                オンラインヨガレッスンのサブスクリプションサービス。月4回（各45分）の認定講師によるライブセッションをGoogle Meet経由でご提供します。
              </Row>
              <Row label="販売価格">
                月額 US$19.99（税込）<br />
              ...
              <Row label="動作環境">
                安定したインターネット接続環境が必要です。Google Meetが動作するブラウザ（最新版のChrome推奨）およびカメラ・マイクを備えたデバイスが必要です。
              </Row>
              <Row label="免責事項">
