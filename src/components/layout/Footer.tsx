    ...
    <footer className="bg-navy-900 text-navy-300 pt-10 pb-6 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8 mb-8">
          ...
          {/* Nav links */}
          <div>
            <p className="text-xs uppercase tracking-widest text-navy-500 mb-3">{t('nav_title')}</p>
          ...
          {/* Legal links */}
          <div>
            <p className="text-xs uppercase tracking-widest text-navy-500 mb-3">{t('legal_title')}</p>
            <div className="flex flex-col gap-2 text-sm">
